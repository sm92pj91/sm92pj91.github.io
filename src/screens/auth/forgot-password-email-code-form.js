  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        AuthService.forgotPasswordSetNew(values.username, values.code,
            values.password)
      }
    });
  };
...
export const
    WrappedForgotPasswordEmailCodeForm = Form.create({name: 'normal_login'})(
        ForgotPasswordEmailCodeForm);
